                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-secondary btn-sm" href="views/admin/crud_buku/buku_edit.php?ID_Buku=<?php echo $ID_Buku ?>">Edit</a> |
                                    <a class="btn btn-danger btn-sm" href="crud_buku/buku_konfirmasi_hapus.php?ID_Buku=<?php echo $ID_Buku ?>">Hapus</a>
                                </td>
                            </tr>
                        <?php
                        }
...
<div class="modal fade" id="TambahDataBuku" tabindex="-1" aria-labelledby="TambahDataBuku" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <form method="Post" name="frm" action="views/admin/crud_buku/simpan.php">
	  <div class="mb-3">
